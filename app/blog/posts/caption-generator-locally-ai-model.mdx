...
```bash
git clone [https://github.com/SAGAR-TAMANG/minimalist-one-word-subtitle-generator.git](https://github.com/SAGAR-TAMANG/minimalist-one-word-subtitle-generator.git)
