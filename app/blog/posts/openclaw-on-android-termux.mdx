...
summary: 'Turn your Android phone into a 24/7 autonomous AI gateway. Learn how to bypass Bionic kernel restrictions to run OpenClaw (Clawdbot) flawlessly in your pocket.'
---
...
## Video Guide coming soon (tomorrow 8 am)
...
* **The UI:** Access your dashboard by going to `http://127.0.0.1:18789` in your phone's browser. Get your token using `openclaw config get gateway.auth.token` or in the file `~/.openclaw/openclaw.json`.
